...
exports.generateContinuityCapsule = generateContinuityCapsule;
exports.calculateFraudScore = calculateFraudScore;
const AI_MOCK = process.env.AI_MOCK !== "false";
async function generateContinuityCapsule(patientRecords) {
    if (AI_MOCK) {
        return {
            bloodGroup: "O+",
...
async function calculateFraudScore(prescriptionData) {
    if (AI_MOCK) {
